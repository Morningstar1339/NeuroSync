  ...
  const sections = [
    ...
    },
    {
      ...
      content: [
        ...
        '• Time-based: "Do not take between 10 PM and 6 AM"',
        '• Dosage-based: "Do not exceed 200mg in 24 hours"',
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        <ThemedView style={styles.intro}>
          <ThemedText style={styles.introText}>
            {
              'NeuroSync is a self-experimentation app for tracking how supplements affect your cognitive performance and physical symptoms. This guide covers all features and best practices for effective tracking.'
            }
          </ThemedText>
        </ThemedView>
        ...
        <ThemedView style={styles.footer}>
          <ThemedText style={styles.footerText}>
            {
              'Having trouble? Check that your data is being saved properly by running a test export. All your data stays on your device - there&apos;s no cloud sync or external dependencies.'
            }
          </ThemedText>
